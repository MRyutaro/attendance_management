# Generated by Django 4.0.4 on 2023-06-12 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.company')),
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='招待された人', to=settings.AUTH_USER_MODEL)),
                ('inviter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='招待した人', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '招待',
