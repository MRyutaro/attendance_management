# Generated by Django 4.0.4 on 2023-06-14 01:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_time', models.DateTimeField(default=datetime.datetime(2023, 6, 15, 1, 44, 12, 273687, tzinfo=utc), help_text='招待URLの有効期限です。デフォルトは1日です。')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.company')),
                ('invitee_role', models.ForeignKey(help_text='招待された人の権限です。', on_delete=django.db.models.deletion.CASCADE, related_name='招待された人の権限', to='api.role')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('inviter', 'invitee_email', 'invitee_role', 'company'), name='unique_invitation'),
        ),
        migrations.AddConstraint(
